...
import com.jf_eam_project.imagetools.PhotoView;
import com.jf_eam_project.ui.adapter.HackyViewPager;
...
//			String imageUrl = Scheme.FILE.wrap(list.get(position));
			...
			ImageDownLoader.showLocationImage(list.get(position), photoView, R.mipmap.ic_launcher);
